...
export const adminApi = {
  ...
  approveWorkshop: async (workshopId) => {
    const res = await apiRequest(`/admin/workshops/${workshopId}/approve`, {
      method: "POST",
      requiresAuth: true,
    });
    return res.data;
  ...
  rejectWorkshop: async (workshopId, reason) => {
    const res = await apiRequest(`/admin/workshops/${workshopId}/reject`, {
      method: "POST",
  ...
  suspendWorkshop: async (workshopId, reason) => {
    const res = await apiRequest(`/admin/workshops/${workshopId}/suspend`, {
      method: "POST",
      body: { reason: reason || "Suspended by administrator" },
      requiresAuth: true,
    });
    return res.data;
  },

  reactivateWorkshop: async (workshopId) => {
    const res = await apiRequest(`/admin/workshops/${workshopId}/reactivate`, {
      method: "POST",
      requiresAuth: true,
    });
    return res.data;
...
export { adminServicesApi } from "./adminServices";
export { adminAuditApi } from "./adminAudit";
export { adminSystemApi } from "./adminSystem";
export { adminUsersApi } from "./adminUsers";
export { adminBookingsApi } from "./adminBookings";
export { adminWorkshopJobsApi } from "./adminWorkshopJobs";
export { adminReportsApi } from "./adminReports";
