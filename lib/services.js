...
export const servicesApi = {
  /**
   * Fetch all active services for public consumers (e.g. partner onboarding, landing page)
   * GET /api/v1/workshops/services
   */
  async getPublicServices() {
    const res = await apiRequest("/workshops/services", {
      method: "GET",
      requiresAuth: false,
    });
    return res?.data || [];
   ...
   * If logged in, requests /services with authentication context.
   * If not logged in, fetches from public active catalog.
   * GET /api/v1/services -> GET /api/v1/workshops/services
   */
  async getServices() {
