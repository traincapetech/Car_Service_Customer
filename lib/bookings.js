...
export const bookingsApi = {
  ...
  async createBooking({
    ...
    const payload = {
      ...
      ...(latitude !== undefined && latitude !== null && !isNaN(Number(latitude)) ? { latitude: Number(latitude) } : {}),
      ...(longitude !== undefined && longitude !== null && !isNaN(Number(longitude)) ? { longitude: Number(longitude) } : {}),
    };
